    ...
    <section className="hero-sky relative pt-36 pb-10 md:pt-44 overflow-hidden">
      <Container className="text-center">
        <Reveal
          immediate
          y={10}
          className="inline-flex items-center gap-2 rounded-full bg-card border border-border shadow-card px-3 py-1.5 text-xs font-semibold"
        >
        ...
        <Reveal
          ...
          delay={0.08}
          as="h1"
          className="mt-6 font-display text-display-xl text-balance mx-auto max-w-[18ch]"
        >
          Know where you rank. Fix what holds you{" "}
        ...
        <Reveal
          ...
          delay={0.16}
          as="p"
          className="mt-5 text-muted-foreground text-lg max-w-[52ch] mx-auto text-pretty"
        >
          A real browser opens your page, Gemini grades it and explains what to
          fix, and every morning we check your positions on Google in your
          market.
        </Reveal>
        <Reveal
          immediate
